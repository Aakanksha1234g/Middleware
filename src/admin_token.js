...
//     console.log("inside get master admintoken func...")
//     try { 
//         const params = new URLSearchParams();
//         params.append( 'client_id',config.ADMIN_CLIENT_ID);
//         params.append('client_secret', config.ADMIN_CLIENT_SECRET);
//         params.append('grant_type', 'client_credentials');
//         const response = await axios.post(
//             `${config.KEYCLOAK_URL}/realms/${config.KEYCLOAK_DEFAULT_REALM}/protocol/openid-connect/token`,
//             params,
//             {headers: { 'Content-Type': 'application/x-www-form-urlencoded' }}
//         );
//         console.log(`response data : ${response.data}`);
...
// module.exports = {getMasterAdminToken};